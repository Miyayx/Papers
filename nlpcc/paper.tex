...
\begin{itemize}
  ...
  \item We prune the original taxonomy, which is extracted from encyclopedia category system, to retrieve more precise \emph{SubClassOf} and \emph{InstanceOf} relations in ontology.
...
\begin{equation}
    O = <C,I,P,H^C>
\end{equation}
where $C$, $I$, $P$ are the sets of concepts, instances, and properties, respectively. $H^C$ represents the hierarchical relationships of concepts. A Taxonomy includes two types of relationships, which are \emph{SubClassOf} of concept-concept and \emph{InstanceOf} of concept-instance.
